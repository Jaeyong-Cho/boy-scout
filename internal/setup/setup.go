...
// Run creates a skill file at baseDir/.agent/skills/gardener/SKILL.md and copies
// the gardener binary to baseDir/.agent/bin/gardener. It overwrites if they already exist.
